...
import { Journal } from './results/results.model';
...
export class AppComponent {
    title = 'Long-term Recurrence and Complications Associated With Elective Incisional Hernia Repair.';
    abstract = 'Importance: Prosthetic mesh is frequently used to reinforce the repair of abdominal wall ' +
